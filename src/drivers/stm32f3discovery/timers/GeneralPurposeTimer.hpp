...
private:
    ...
    /**
     * @brief Enables DMA and interrupt functionality for the timer.
     *
     * This function configures the timer to trigger DMA transfers and interrupt handling.
     ...
     *
     * This setup is useful for managing asynchronous operations like data transfer or processing events generated by the timer.
     *
     * @note This function assumes that the timer instance (`mpTimer`) has been previously initialized.
     *
    ...
    /**
     * @brief Disables DMA and interrupt functionality for the timer.
     *
     * This function clears the enable flags for DMA requests and interrupts in the timer's DIER register.
     ...
     *
     * This is typically used to prevent the timer from generating DMA requests or triggering interrupts.
     *
     * @note This function assumes that the timer instance (`mpTimer`) has been previously initialized.
     *
