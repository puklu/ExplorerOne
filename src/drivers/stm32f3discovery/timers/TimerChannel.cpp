...
void TimerChannel::Init(Timer::eCaptureCompareSelection selection)
{
    ...
    {
        mOutputCompareConfig.mOutputCompareEnable =
            Timer::eOutputCompareClearEnable::DISABLE;
        mOutputCompareConfig.mOutputComparePreloadEnable =
            Timer::eOutputComparePreloadEnable::DISABLE;
        mOutputCompareConfig.mOutputCompareMode =
            Timer::eOutputCompareMode::FROZEN;
        if (mOutputCompareConfig.mOutputCompareMode ==
    ...
    {
        mInputCaptureConfig.mInputCaptureFilter =
            Timer::eInputCaptureFilter::NO_FILTER;
        mInputCaptureConfig.mInputCapturePrescaler =
            Timer::eInputCapturePrescaler::NO_PRESCALER;
    }
}
