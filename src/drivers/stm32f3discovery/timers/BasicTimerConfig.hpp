 ...
 * The configurations is the same as BaseTimerConfig so it inherits all of them
 * from the base class.
 *
 ...
 *
 * This class encapsulates the necessary configuration parameters for
 * initializing a basic timer, including prescaler value, auto-reload register
 * value, interrupt callback, counter mode, preload settings, update sources,
 * and more.
 */
