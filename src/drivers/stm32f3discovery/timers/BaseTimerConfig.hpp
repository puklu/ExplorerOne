...
class BaseTimerConfig
{
   public:
    ...
    /**
     * @brief Prescaler value for the timer. Determines the clock division
     * before counting.
     */
     ...
     */
    Timer::eOnePulseMode mOnePulseMode =
        Timer::eOnePulseMode::DISABLE_ONE_PULSE_MODE;

    /**
     * @brief Auto-reload preload enable.
     */
    Timer::eAutoReloadPreload mAutoReloadPreload =
        Timer::eAutoReloadPreload::ARR_BUFFERED;
     ...
     */
    Timer::eUpdateEvent mEnableUpdateEvent =
        Timer::eUpdateEvent::ENABLE_EVENT_GENERATION;

    /**
     * @brief Master mode selection for timer synchronization.
     */
    Timer::eMasterModeSelection mMasterModeSelection =
        Timer::eMasterModeSelection::SEND_RESET;

    /**
     * @brief Enable or disable DMA request on update.
     */
    Timer::eUpdateDmaRequest mUpdateDmaRequest =
        Timer::eUpdateDmaRequest::DISABLE;
