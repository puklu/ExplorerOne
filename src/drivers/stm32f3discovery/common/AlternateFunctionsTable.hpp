...
inline const void* aAltFunctionsAdressesPortA
    [IO_PIN_COUNT_PER_PORT][IO_ALT_FUNC_COUNT_FOR_PORT_A] = {
        ...
        {nullptr, TIM16, TIM3, nullptr, TIM8, nullptr, TIM1, nullptr, nullptr,
         nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr},
...
inline const void* aAltFunctionsAdressesPortB
    [IO_PIN_COUNT_PER_PORT][IO_ALT_FUNC_COUNT_FOR_PORT_B] = {
        {nullptr, nullptr, TIM3, nullptr, TIM8, nullptr, TIM1, nullptr, nullptr,
         nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr},
        ...
        {nullptr, TIM2, TIM4, nullptr, TIM8, nullptr, nullptr, USART2, nullptr,
...
inline const void* aAltFunctionsAdressesPortC
    [IO_PIN_COUNT_PER_PORT][IO_ALT_FUNC_COUNT_FOR_PORT_C + 1] = {
...
inline const void* aAltFunctionsAdressesPortD
    [IO_PIN_COUNT_PER_PORT][IO_ALT_FUNC_COUNT_FOR_PORT_D + 1] = {
        // The alternate functions in datasheet start from AF1 instead of
        // AF0. But an extra nullptr is added at index 0 of each row here
        // so that the code using this doesnt need to have a -1
        {nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
...
inline const void* aAltFunctionsAdressesPortE
    [IO_PIN_COUNT_PER_PORT][IO_ALT_FUNC_COUNT_FOR_PORT_E + 1] = {
        // The alternate functions in datasheet start from AF1 instead of
        // AF0. But an extra nullptr is added at index 0 of each row here
        // so that the code using this doesnt need to have a -1
...
inline const void* aAltFunctionsAdressesPortF
    [IO_PIN_COUNT_PER_PORT][IO_ALT_FUNC_COUNT_FOR_PORT_F + 1] = {
        // The alternate functions in datasheet start from AF1 instead of
        // AF0. But an extra nullptr is added at index 0 of each row here
        // so that the code using this doesnt need to have a -1
        {nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, TIM1, nullptr},
