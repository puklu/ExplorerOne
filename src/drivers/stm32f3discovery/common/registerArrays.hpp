...
inline long unsigned int const aExtiImrRegisterBits[IO_PIN_COUNT_PER_PORT] = {
    ...
    EXTI_IMR_MR8,  EXTI_IMR_MR9,  EXTI_IMR_MR10, EXTI_IMR_MR11,
...
// inline long unsigned int const
// aExtiRisingEdgeTriggerRegisterBits[IO_EXTI_LINES_COUNT] =
//     {
//         EXTI_RTSR_TR0, EXTI_RTSR_TR1 , EXTI_RTSR_TR2, EXTI_RTSR_TR3,
//         EXTI_RTSR_TR4, EXTI_RTSR_TR5, EXTI_RTSR_TR6 , EXTI_RTSR_TR7,
//         EXTI_RTSR_TR8, EXTI_RTSR_TR9, EXTI_RTSR_TR10, EXTI_RTSR_TR11 ,
//         EXTI_RTSR_TR12, EXTI_RTSR_TR13, EXTI_RTSR_TR14, EXTI_RTSR_TR11,
//         EXTI_RTSR_TR12 , EXTI_RTSR_TR13, EXTI_RTSR_TR14, EXTI_RTSR_TR15,
//         EXTI_RTSR_TR16, EXTI_RTSR_TR17 , EXTI_RTSR_TR18, EXTI_RTSR_TR19,
//         EXTI_RTSR_TR20, EXTI_RTSR_TR21, EXTI_RTSR_TR22 , EXTI_RTSR_TR29,
//         EXTI_RTSR_TR30, EXTI_RTSR_TR31, EXTI_RTSR2_TR32, EXTI_RTSR2_TR33,
//     };
...
inline long unsigned int const aSyscfgExtiRegisterBits[IO_EXTI_LINES_COUNT]{
    ...
    SYSCFG_EXTICR1_EXTI3,  SYSCFG_EXTICR2_EXTI4,  SYSCFG_EXTICR2_EXTI5,
    SYSCFG_EXTICR2_EXTI6,  SYSCFG_EXTICR2_EXTI7,  SYSCFG_EXTICR3_EXTI8,
...
inline TIM_TypeDef* const aBasicTimersAddress[NUMBER_OF_BASIC_TIMERS] = {TIM6,
                                                                         TIM7};
...
inline TIM_TypeDef* const
    aGeneralPurposeTimersAddress[NUMBER_OF_GENERAL_PURPOSE_TIMERS] = {
        TIM2, TIM3, TIM4, TIM15, TIM16, TIM17};

inline TIM_TypeDef* const
    aAdvancedControlTimersAddress[NUMBER_OF_ADVANCED_CONTROL_TIMERS] = {TIM1,
                                                                        TIM8};

inline long unsigned int const
    aGeneralPurposeTimersEnableMasks[NUMBER_OF_GENERAL_PURPOSE_TIMERS] = {
        RCC_APB1ENR_TIM2EN, RCC_APB1ENR_TIM3EN, RCC_APB1ENR_TIM4EN};

inline IRQn_Type
    aGeneralPurposeTimersIrqNumbers[NUMBER_OF_GENERAL_PURPOSE_TIMERS] = {
        TIM2_IRQn, TIM3_IRQn, TIM4_IRQn};

inline long unsigned int const aGeneralPurposeTimerCcerRegisterMasks
    [GENERAL_PURPOSE_TIMER_NUM_CHANNELS][3] = {
...
inline long unsigned int const
    aGeneralPurposeTimerCcmrOutputCompareRegisterMasks
        [GENERAL_PURPOSE_TIMER_NUM_CHANNELS][11] = {
            {TIM_CCMR1_CC1S, TIM_CCMR1_CC1S_0, TIM_CCMR1_CC1S_1,
             TIM_CCMR1_OC1FE, TIM_CCMR1_OC1PE, TIM_CCMR1_OC1M, TIM_CCMR1_OC1M_0,
             TIM_CCMR1_OC1M_1, TIM_CCMR1_OC1M_2, TIM_CCMR1_OC1M_3,
             TIM_CCMR1_OC1CE},
            {TIM_CCMR1_CC2S, TIM_CCMR1_CC2S_0, TIM_CCMR1_CC2S_1,
             TIM_CCMR1_OC2FE, TIM_CCMR1_OC2PE, TIM_CCMR1_OC2M, TIM_CCMR1_OC2M_0,
             TIM_CCMR1_OC2M_1, TIM_CCMR1_OC2M_2, TIM_CCMR1_OC2M_3,
             TIM_CCMR1_OC2CE},
            {TIM_CCMR2_CC3S, TIM_CCMR2_CC3S_0, TIM_CCMR2_CC3S_1,
             TIM_CCMR2_OC3FE, TIM_CCMR2_OC3PE, TIM_CCMR2_OC3M, TIM_CCMR2_OC3M_0,
             TIM_CCMR2_OC3M_1, TIM_CCMR2_OC3M_2, TIM_CCMR2_OC3M_3,
             TIM_CCMR2_OC3CE},
            {TIM_CCMR2_CC4S, TIM_CCMR2_CC4S_0, TIM_CCMR2_CC4S_1,
             TIM_CCMR2_OC4FE, TIM_CCMR2_OC4PE, TIM_CCMR2_OC4M, TIM_CCMR2_OC4M_0,
             TIM_CCMR2_OC4M_1, TIM_CCMR2_OC4M_2, TIM_CCMR2_OC4M_3,
             TIM_CCMR2_OC4CE},
};

inline long unsigned int const aGeneralPurposeTimerCcmrInputCaptureRegisterMasks
    [GENERAL_PURPOSE_TIMER_NUM_CHANNELS][11] = {
        {TIM_CCMR1_CC1S, TIM_CCMR1_CC1S_0, TIM_CCMR1_CC1S_1, TIM_CCMR1_IC1PSC,
         TIM_CCMR1_IC1PSC_0, TIM_CCMR1_IC1PSC_1, TIM_CCMR1_IC1F,
         TIM_CCMR1_IC1F_0, TIM_CCMR1_IC1F_1, TIM_CCMR1_IC1F_2,
         TIM_CCMR1_IC1F_3},
        {TIM_CCMR1_CC2S, TIM_CCMR1_CC2S_0, TIM_CCMR1_CC2S_1, TIM_CCMR1_IC2PSC,
         TIM_CCMR1_IC2PSC_0, TIM_CCMR1_IC2PSC_1, TIM_CCMR1_IC2F,
         TIM_CCMR1_IC2F_0, TIM_CCMR1_IC2F_1, TIM_CCMR1_IC2F_2,
         TIM_CCMR1_IC2F_3},
        {TIM_CCMR2_CC3S, TIM_CCMR2_CC3S_0, TIM_CCMR2_CC3S_1, TIM_CCMR2_IC3PSC,
         TIM_CCMR2_IC3PSC_0, TIM_CCMR2_IC3PSC_1, TIM_CCMR2_IC3F,
         TIM_CCMR2_IC3F_0, TIM_CCMR2_IC3F_1, TIM_CCMR2_IC3F_2,
         TIM_CCMR2_IC3F_3},
        {TIM_CCMR2_CC4S, TIM_CCMR2_CC4S_0, TIM_CCMR2_CC4S_1, TIM_CCMR2_IC4PSC,
         TIM_CCMR2_IC4PSC_0, TIM_CCMR2_IC4PSC_1, TIM_CCMR2_IC4F,
         TIM_CCMR2_IC4F_0, TIM_CCMR2_IC4F_1, TIM_CCMR2_IC4F_2,
         TIM_CCMR2_IC4F_3},
};
...
struct aRcc
{
    ...
    struct RCC_CFGR
    {
        ...
        static constexpr uint32_t SYSTEM_CLOCK_SWITCH_STATUS_POSITION =
            RCC_CFGR_SWS_Pos;
        ...
        {
            static constexpr uint32_t HSI_DIVIDED_BY_2 =
                RCC_CFGR_PLLSRC_HSI_DIV2;
            static constexpr uint32_t HSE_DIVIDED_BY_PREDIV =
                RCC_CFGR_PLLSRC_HSE_PREDIV;
        };

        static constexpr uint32_t PLL_MULTIPLICATION_FACTOR = RCC_CFGR_PLLMUL;
        static constexpr uint32_t PLL_MULTIPLICATION_FACTOR_POSITION =
            RCC_CFGR_PLLMUL_Pos;
    ...
    struct RCC_CFGR3
    {
        ...
        static constexpr uint32_t USART1_SOURCE_SELECTION_POSITION =
        ...
        static constexpr uint32_t I2C1_SOURCE_SELECTION_POSITION =
        ...
        static constexpr uint32_t I2C2_SOURCE_SELECTION_POSITION =
        ...
        static constexpr uint32_t TIM1_SOURCE_SELECTION_POSITION =
        ...
        static constexpr uint32_t TIM8_SOURCE_SELECTION_POSITION =
        ...
        static constexpr uint32_t USART2_SOURCE_SELECTION_POSITION =
        ...
        static constexpr uint32_t USART3_SOURCE_SELECTION_POSITION =
        ...
        static constexpr uint32_t UART4_SOURCE_SELECTION_POSITION =
        ...
        static constexpr uint32_t UART5_SOURCE_SELECTION_POSITION =
    ...
    struct RCC_AHB_CLOCK_ENABLE
    {
        ...
        static constexpr uint32_t TOUCH_SENSING_CONTROLLER_CLOCK =
            RCC_AHBENR_TSCEN;
