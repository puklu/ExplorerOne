 ...
 *
 * Provides blocking delays and tick counting using the MCU's SysTick
 * peripheral. Inherits from ISysTick interface.
 */
class SysTickImpl : public ISysTick
{
   ...
   private:
    SysTick_Type*
        mpSystick;  /// Pointer to the hardware SysTick peripheral registers
