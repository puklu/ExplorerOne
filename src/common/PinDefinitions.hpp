...
enum class eRccClockSource : uint8_t
{
    RCC_CLOCK_SOURCE_HSI,
    RCC_CLOCK_SOURCE_HSE,
    RCC_CLOCK_SOURCE_PLL,
};

enum class eRccClocks : uint8_t
{
    RCC_CLOCK_SOURCE_SYSCLK,
    RCC_CLOCK_SOURCE_HSI,
    RCC_CLOCK_SOURCE_HSE,
    RCC_CLOCK_SOURCE_PLL,
    RCC_CLOCK_SOURCE_LSE,
    RCC_CLOCK_SOURCE_LSI,
    RCC_CLOCK_SOURCE_ADC,
...
{
    MULTIPLY_INPUT_CLK_BY_2,
    MULTIPLY_INPUT_CLK_BY_3,
    MULTIPLY_INPUT_CLK_BY_4,
    MULTIPLY_INPUT_CLK_BY_5,
    MULTIPLY_INPUT_CLK_BY_6,
    MULTIPLY_INPUT_CLK_BY_7,
    MULTIPLY_INPUT_CLK_BY_8,
    MULTIPLY_INPUT_CLK_BY_9,
    MULTIPLY_INPUT_CLK_BY_10,
    MULTIPLY_INPUT_CLK_BY_11,
    MULTIPLY_INPUT_CLK_BY_12,
    MULTIPLY_INPUT_CLK_BY_13,
    MULTIPLY_INPUT_CLK_BY_14,
    MULTIPLY_INPUT_CLK_BY_15,
    MULTIPLY_INPUT_CLK_BY_16,
};

enum class eApb1Apb2Prescaler : uint8_t
{
    HCLK_DIVIDED_BY_1,
    HCLK_DIVIDED_BY_2,
    HCLK_DIVIDED_BY_4,
...
enum class eAhbPrescaler : uint8_t
{
    SYSCLK_DIVIDED_BY_1,
    SYSCLK_DIVIDED_BY_2,
    SYSCLK_DIVIDED_BY_4,
